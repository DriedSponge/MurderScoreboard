...
local function ToggleScoreboard(toggle)
    if toggle then
        ...
        MurderBoardScoreboard:Background(DSMSBGColor)
        ...
        title:DualText(GetHostName(), "Murder_ScoreBoardTOPFont", DSMSPrimaryTextColor, DriedSpongeMurderScoreboardSlogan, "Murder_ScoreBoardFontSmall", DSMSSecondaryTextColor, TEXT_ALIGN_CENTER)
        MurderBoardScoreboard:Text("Map: " .. game.GetMap(), "Murder_ScoreBoardFont", DSMSPrimaryTextColor, TEXT_ALIGN_RIGHT, -10, -h / 2.1)
        MurderBoardScoreboard:Text("Players: "..player.GetCount().."/" .. game.MaxPlayers(), "Murder_ScoreBoardFont", DSMSPrimaryTextColor, TEXT_ALIGN_LEFT, 10, -h / 2.1)
        ...
        playerstab:Text("Players", "Murder_ScoreBoardFontSmall2", DSMSSecondaryTextColor, TEXT_ALIGN_CENTER, 0, 0)
        ...
        JoinPlayers:SetTextColor(DSMSSecondaryTextColor)
        ...
        spectatorstab:Text("Spectators", "Murder_ScoreBoardFontSmall2", DSMSSecondaryTextColor, TEXT_ALIGN_CENTER, 0, 0)
        ...
        JoinSpectators:BarHover(DSMSHoverClor, 3)
        JoinSpectators:Dock(RIGHT)
        JoinSpectators:SetTextColor(DSMSSecondaryTextColor)
        ...
        pingply:SetColor(DSMSPrimaryTextColor)
    end
    ...
    for k, v in pairs(team.GetPlayers(1)) do
        ...
        pingply2:SetColor(DSMSPrimaryTextColor)
        end
